...
let animal1 = new Animal("Roedor", "Rato", 0.5, ["Terra", "Lixo", "Comida"]);
console.log(animal1);
...
console.log(animal1.habitat[0]);
console.log(animal1.getEspecie);
let animal2 = new Animal("Mamífero", "Baleia", 5000000, ["Água"]);
console.log(animal2);
...
console.log(animal2.habitat[0]);
console.log(animal2.getEspecie);
let animal3 = new Animal("Humano", "Mateus Felipe", 75, ["Água", "Terra", "Fogo", "Ar"]);
console.log(animal3);
...
console.log(fulano.calcularMedia());
console.log(fulano.apresentar());
let professor = new Professor("Rubem Oliota", 31, ["Algoritmo", "Java", "Typescript"], 80, 180);
